...
- If you need quotation marks inside a string, use escaped quotes `\\”` or typographic quotes `“”`.
- Every field value must remain valid JSON after serialization. Invalid example: `”calling “risky” the same as “infeasible””`; valid example: `”calling \\\”risky\\\” the same as \\\”infeasible\\\””` or use single quotes in prose.
