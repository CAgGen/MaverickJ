...
1. **`README.md`** (English) — update any affected sections (architecture, config, usage, project structure, FAQ, etc.)
2. **`README_CN.md`** (Chinese) — apply the same updates in Chinese, keeping both files in sync
